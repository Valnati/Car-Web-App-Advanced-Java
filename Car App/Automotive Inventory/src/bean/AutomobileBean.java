...
public class AutomobileBean {
	  ...
	  public void setWithAutomobile(Automobile auto) {
			...
			ArrayList<Option> transmissionOptions = transmissionOptionSet.getOption();
			...
			ArrayList<Option> absOptions = absOptionSet.getOption();
			...
			ArrayList<Option> bagOptions = bagOptionSet.getOption();
			...
			ArrayList<Option> moonroofOptions = moonroofOptionSet.getOption();
